...
const F_EXTERIOR_COLOR_REQUESTED =
  process.env.AIRTABLE_REQ_FIELD_EXTERIOR_COLOR_REQUESTED ||
...
export async function createBuyerRequest(payload) {
  ...
  const exteriorColorRequested = cleanString(payload.exteriorColorRequested);
  ...
  const fields = {
    ...
    [F_EXTERIOR_COLOR_REQUESTED]: exteriorColorRequested,
