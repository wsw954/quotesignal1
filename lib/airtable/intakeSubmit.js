...
const F_CURRENT_ROUND =
  process.env.AIRTABLE_REQ_FIELD_CURRENT_ROUND || "Current Round";
const F_R1_SENT = process.env.AIRTABLE_REQ_FIELD_R1_SENT || "R1 Sent";
const F_DEALER_CAP = process.env.AIRTABLE_REQ_FIELD_DEALER_CAP || "Dealer Cap";
...
export async function createBuyerRequest(payload) {
  ...
  const fields = {
    ...
    [F_PRIORITY]: priority,
    [F_CURRENT_ROUND]: currentRound,
    [F_R1_SENT]: r1Sent,
    [F_DEALER_CAP]: dealerCap,
