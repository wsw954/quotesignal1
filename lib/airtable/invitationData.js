...
function normalizeInvitationRecord(record, dealerLookup) {
  ...
  const rfqTemplateType = textValue(fields["RFQ Template Type"]);
  ...
  return {
    ...
    dealerMainContact: dealer?.mainContact || "",
    dealerEmail: dealer?.mainEmail || "",
    dealerPhone: dealer?.mainContactPhone || "",
